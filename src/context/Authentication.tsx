        ...
        <form
            ...
            <div className="block px-6 py-6 w-full max-w-[460px] h-fit bg-background-content shadow-md rounded-2xl">
                ...
                <div className="flex w-full h-fit mt-2 justify-center">
                    <a rel="link" href="/authentcation/register" className="text-gray-800/60 text-sm underline">Sign up</a>
                </div>
            </div>
        </form>
    )
    ...
    return (
        <div className="flex w-full h-full justify-center items-center pb-10">
            <div className="block px-6 py-6 w-full max-w-[460px] h-fit bg-background-content shadow-md rounded-2xl">
                ...
                <div className="flex w-full h-fit mt-2 justify-center">
                    <a rel="link" href="/authentication/login" className="text-gray-800/60 text-sm underline">Cancel</a>
                </div>
            </div>
        </div>
    )
...
export default function Authentication() {
    return(
        <div className={`flex w-full h-screen justify-center items-center font-JetBrains`}>
            <Routes>
